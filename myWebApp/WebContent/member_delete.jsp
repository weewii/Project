...
<%
	...
	ResultSet myresult = stmt.executeQuery("SELECT * FROM member ORDER BY username");
%>	
	...
	<table width="300" border="1">
	  <br><tr id=color1>
		...
		<%while((myresult!=null) && (myresult.next())) { %>
			  <tr id=color2>
			    <td><div align="center"><%=myresult.getString("username")%></div></td>
			    <td><%=myresult.getString("password")%></td>
			    <td align="center"><a href="delete.jsp?username=<%=myresult.getString("username")%>" onclick="return confirm('Are you sure to delete?')">Delete</a></td>
			  </tr>
     	<%}%>
	</table>
